...
class StandardRenderPass : VRenderPass {
    ...
    private VImage createImage(int width, int height) {
        ...
        auto result = new VImage(new Image(VDevice(), imageInfo), MemoryProperties.MemoryType.Flags.DeviceLocal);
        result.transit(ImageLayout.Undefined, ImageLayout.DepthStencilAttachmentOptimal, ImageAspect.Depth);
        return result;
    }
